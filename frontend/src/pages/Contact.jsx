...
import { ChevronRight, HelpCircle, LogIn, MessageCircleQuestion, MapPin, Phone, Mail } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#fff7ee] text-[#2b2018]">
      ...
      <main className="mx-auto grid max-w-[1400px] gap-4 px-4 pb-10 pt-24 lg:grid-cols-[360px_1fr]">
        <aside className="max-h-[82vh] overflow-y-auto rounded border border-[#edd8bc] bg-white">
          ...
          <section className="border-t border-[#f0e3d3] px-6 py-5">
            <p className="text-xs font-bold tracking-wide text-[#7a522f] uppercase mb-4">Our Details</p>
            <div className="space-y-4 text-sm text-[#2b2018]">
              <div className="flex items-start gap-3">
                <MapPin size={18} className="text-[#8a6038] mt-0.5 shrink-0" />
                <p>123 Radiance Blvd, Suite 400<br />New York, NY 10001</p>
              </div>
              <div className="flex items-start gap-3">
                <Phone size={18} className="text-[#8a6038] mt-0.5 shrink-0" />
                <p>+1 (800) 123-4567</p>
              </div>
              <div className="flex items-start gap-3">
                <Mail size={18} className="text-[#8a6038] mt-0.5 shrink-0" />
                <p>support@actshiine.com</p>
              </div>
              <div className="flex items-center gap-3 pt-2">
                <a href="#" className="text-[#8a6038] hover:text-[#7a522f] transition"><InstagramIcon size={20} /></a>
                <a href="#" className="text-[#8a6038] hover:text-[#7a522f] transition"><TwitterIcon size={20} /></a>
                <a href="#" className="text-[#8a6038] hover:text-[#7a522f] transition"><FacebookIcon size={20} /></a>
              </div>
            </div>
          </section>
        </aside>
