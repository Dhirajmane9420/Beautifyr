    ...
    <div className="relative w-full h-screen">
      ...
      <div className="relative z-10 flex items-center h-full justify-start">
        <div className="w-full px-6 lg:px-12">
          <div className="max-w-2xl mt-16 sm:mt-0">
            {/* Tag */}
            <span className="inline-block bg-amber-100 text-amber-800 px-4 py-1 rounded-full text-xs sm:text-sm font-semibold">
              DERMATOLOGIST RECOMMENDED
            </span>

            {/* Heading */}
            <h1 className="mt-4 sm:mt-6 text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 leading-tight">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <button className="bg-slate-900 text-white px-6 py-3.5 sm:py-3 rounded-full font-semibold hover:bg-slate-800 transition text-center">
                SHOP NOW
              </button>

              <button className="bg-white text-slate-900 px-6 py-3.5 sm:py-3 rounded-full font-semibold border border-gray-300 hover:bg-gray-100 transition text-center">
                EXPLORE CATEGORIES
              </button>
            </div>
          </div>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-20">
        <div className="max-w-7xl mx-auto">
          {/* Heading */}
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-teal-900">Shop by Category</h2>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between flex-wrap gap-4">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-teal-900">Featured Selections</h2>
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm hover:shadow-md transition">
              <div className="relative overflow-hidden rounded-2xl">
                ...
                />
                <button className="absolute top-4 right-4 bg-white w-10 h-10 sm:w-11 sm:h-11 rounded-full flex items-center justify-center text-teal-700 text-lg sm:text-xl shadow">
                  ♥
                </button>
              </div>
              ...
              <div className="mt-4 sm:mt-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-3">
                <span className="text-2xl sm:text-3xl font-bold text-teal-800">$48.00</span>
                <button className="w-full xl:w-auto bg-teal-700 text-white px-5 py-2.5 rounded-full font-semibold hover:bg-teal-800 transition text-sm sm:text-base">
                  ADD TO CART
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm hover:shadow-md transition">
              ...
              <div className="mt-4 sm:mt-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-3">
                <span className="text-2xl sm:text-3xl font-bold text-teal-800">$24.00</span>
                <button className="w-full xl:w-auto bg-teal-700 text-white px-5 py-2.5 rounded-full font-semibold hover:bg-teal-800 transition text-sm sm:text-base">
                  ADD TO CART
                </button>
              </div>
            ...
            <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm hover:shadow-md transition">
              ...
              <div className="mt-4 sm:mt-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-3">
                <span className="text-2xl sm:text-3xl font-bold text-teal-800">$52.00</span>
                <button className="w-full xl:w-auto bg-teal-700 text-white px-5 py-2.5 rounded-full font-semibold hover:bg-teal-800 transition text-sm sm:text-base">
                  ADD TO CART
                </button>
              </div>
            ...
            <div className="bg-white rounded-3xl p-4 sm:p-5 shadow-sm hover:shadow-md transition">
              ...
              <div className="mt-4 sm:mt-6 flex flex-col xl:flex-row items-start xl:items-center justify-between gap-3">
                <span className="text-2xl sm:text-3xl font-bold text-teal-800">$32.00</span>
                <button className="w-full xl:w-auto bg-teal-700 text-white px-5 py-2.5 rounded-full font-semibold hover:bg-teal-800 transition text-sm sm:text-base">
                  ADD TO CART
                </button>
              </div>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 text-center">
          ...
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-emerald-100 flex items-center justify-center text-2xl sm:text-3xl text-teal-800 shadow-sm">
              ✔
            </div>
            <h3 className="mt-4 sm:mt-6 text-2xl sm:text-3xl font-semibold text-teal-900">
              Authentic Products
            </h3>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-20">
        <div className="max-w-7xl mx-auto">
          {/* Heading */}
          <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold text-teal-900">
            Targeted Solutions
          </h2>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-24">
        <div className="max-w-7xl mx-auto">
          {/* Heading */}
          <h2 className="text-center text-3xl sm:text-4xl md:text-5xl font-bold text-teal-900">
          ...
          <div className="mt-10 sm:mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            {/* Card 1 */}
            <div className="bg-white rounded-[2rem] p-6 sm:p-8 md:p-10 shadow-sm border-l-4 border-teal-700">
              ...
              <h4 className="mt-8 text-teal-800 text-xl lg:text-2xl font-semibold">
                — Elena M.
              </h4>
            </div>
      ...
      <section className="bg-[#f7f5f2] px-4 sm:px-6 py-12 lg:py-20">
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] bg-teal-800 px-6 py-10 sm:py-16 md:px-14 lg:px-16">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 items-center gap-12 text-center lg:text-left">
              ...
              <div className="text-white flex flex-col items-center lg:items-start">
                ...
                <button className="mt-8 sm:mt-10 bg-white text-teal-800 px-6 sm:px-8 py-3.5 sm:py-4 rounded-2xl text-base sm:text-lg font-bold tracking-wide hover:bg-gray-100 transition w-full sm:w-auto">
                  CLAIM OFFER
                </button>
              </div>
      ...
      <section className="bg-[#f7f5f2] pt-12 lg:pt-20">
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            ...
            />
            <button className="w-full sm:w-auto bg-teal-800 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-2xl text-base sm:text-lg font-bold tracking-wide hover:bg-teal-900 transition">
              SUBSCRIBE
            </button>
          </div>
        ...
        {/* Footer Main */}
        <div className="mt-16 sm:mt-20 bg-[#f4f4f4] px-6 py-12 lg:py-20">
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
            
            {/* Brand */}
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold text-teal-900">Clinical Sanctuary</h3>
              ...
              <div className="mt-6 sm:mt-8 flex items-center gap-5 text-2xl sm:text-3xl text-teal-800">
                <span>🌐</span>
                <span>@</span>
              </div>
            </div>
            ...
            {/* Products */}
            <div>
              <h4 className="text-xl sm:text-2xl font-semibold text-teal-900">Products</h4>
            ...
            {/* Support */}
            <div>
              <h4 className="text-xl sm:text-2xl font-semibold text-teal-900">Support</h4>
              <ul className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-gray-500 text-base sm:text-lg">
            ...
            {/* Newsletter Small */}
            <div>
              <h4 className="text-xl sm:text-2xl font-semibold text-teal-900">Newsletter</h4>
